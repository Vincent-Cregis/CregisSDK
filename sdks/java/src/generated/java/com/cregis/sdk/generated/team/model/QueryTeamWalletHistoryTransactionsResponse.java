 ...
 */
@JsonPropertyOrder({
  QueryTeamWalletHistoryTransactionsResponse.JSON_PROPERTY_PAGE_NUM,
  QueryTeamWalletHistoryTransactionsResponse.JSON_PROPERTY_PAGE_SIZE,
  QueryTeamWalletHistoryTransactionsResponse.JSON_PROPERTY_ROWS,
  QueryTeamWalletHistoryTransactionsResponse.JSON_PROPERTY_TOTAL
})
...
public class QueryTeamWalletHistoryTransactionsResponse {
  ...
  public QueryTeamWalletHistoryTransactionsResponse addRowsItem(TeamWalletTransaction rowsItem) {
    if (this.rows == null) {
  ...
  /**
   * Return true if this QueryTeamWalletHistoryTransactionsResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    QueryTeamWalletHistoryTransactionsResponse queryTeamWalletHistoryTransactionsResponse = (QueryTeamWalletHistoryTransactionsResponse) o;
    return Objects.equals(this.pageNum, queryTeamWalletHistoryTransactionsResponse.pageNum) &&
        Objects.equals(this.pageSize, queryTeamWalletHistoryTransactionsResponse.pageSize) &&
        Objects.equals(this.rows, queryTeamWalletHistoryTransactionsResponse.rows) &&
        Objects.equals(this.total, queryTeamWalletHistoryTransactionsResponse.total);
  }
  ...
  public String toString() {
    ...
    sb.append("class QueryTeamWalletHistoryTransactionsResponse {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    private QueryTeamWalletHistoryTransactionsResponse instance;

    public Builder() {
      this(new QueryTeamWalletHistoryTransactionsResponse());
    }

    protected Builder(QueryTeamWalletHistoryTransactionsResponse instance) {
      this.instance = instance;
    }

    public QueryTeamWalletHistoryTransactionsResponse.Builder pageNum(Integer pageNum) {
      this.instance.pageNum = pageNum;
      return this;
    }
    public QueryTeamWalletHistoryTransactionsResponse.Builder pageSize(Integer pageSize) {
      this.instance.pageSize = pageSize;
      return this;
    }
    public QueryTeamWalletHistoryTransactionsResponse.Builder rows(List<TeamWalletTransaction> rows) {
      this.instance.rows = rows;
      return this;
    }
    public QueryTeamWalletHistoryTransactionsResponse.Builder total(Long total) {
    ...
    /**
    * returns a built QueryTeamWalletHistoryTransactionsResponse instance.
    *
    * The builder is not reusable.
    */
    public QueryTeamWalletHistoryTransactionsResponse build() {
      try {
  ...
  */
  public static QueryTeamWalletHistoryTransactionsResponse.Builder builder() {
    return new QueryTeamWalletHistoryTransactionsResponse.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public QueryTeamWalletHistoryTransactionsResponse.Builder toBuilder() {
    return new QueryTeamWalletHistoryTransactionsResponse.Builder()
      .pageNum(getPageNum())
